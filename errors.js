...
(function(){
  ...
  class AppError extends Error {
     ...
     * @param {{ code?: string, status?: number, details?: any, cause?: any } | null | undefined} [opts]
     */
  ...
  /**
   * @param {unknown} err
   * @returns {{ error: string, code: string, status: number, details?: any }}
   */
  function errorToJson(err){
    const e = toAppError(err);
    /** @type {{ error: string, code: string, status: number, details?: any }} */
