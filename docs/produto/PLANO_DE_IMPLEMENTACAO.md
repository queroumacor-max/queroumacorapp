...
| 1.4 | Confirmar execução em produção de `2026-09-16-business-logic-security-audit.sql`, `2026-09-17-rate-limit-sliding-window.sql` e `2026-09-17-whatsapp-followup-claim.sql` (sem registro de execução) | P | Painel |
